...
/*Merge the modify of NV check destoryed by dingjian 20180607 begin*/
#ifdef CONFIG_KERNEL_CUSTOM_TULIP
#define CHECK_NV_DESTROYED_MI
#endif
/*Merge the modify of NV check destoryed by dingjian 20180607 end*/
